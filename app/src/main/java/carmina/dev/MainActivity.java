...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemsAdapter.OnClickListener onClickListener = new ItemsAdapter.OnClickListener() {
            ...
            public void onItemClicked(int position) {
                ...
                // use intent -> a request to android system
                // MainActivity.this - current activity
                // EditActivity.class - class we would like to go to
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Notify user that item was added successfully
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        //check if request code matches with the request code we passed in, make sure result code is ok
